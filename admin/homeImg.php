...
<html lang="en">
    <head>
        ...
        <title>Maruti Studio | Homepage Images </title>
        <?php
            include('css.php')
        ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Homepage Images</h1>
                                ...
                                <form class="homeImg" action="" name="homeImg" id="homeImg" enctype="multipart/form-data">
                                    <div class="container-head">
                                        <div class="row inner-div mb-3">
                                            ...
                                            Homepage Image 1  <span class="mandatory">*</span>
                                            </div>
                                        ...
                                        <div class="row inner-div mb-3">
                                            <div class="col-sm-2 mb-3">
                                            Homepage Image 2  <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-4 mb-3">
                                        ...
                                        <div class="row inner-div mb-3">
                                            <div class="col-sm-2 mb-3">
                                            Homepage Image 3  <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-4 mb-3">
                                                <input type="file" name="homeImg3" id="homeImg3" class="form-control">
                                            </div>
                                            
                                            <input type="hidden" name="endurl" id="endurl" value="updateHomeImage" />
                                        </div>
    ...
    $(function() {
        ...
        $("form[name='homeImg']").validate({
            ...
            messages: {
                ...
                homeImg3: "Please select Slider Image 3"
            },
