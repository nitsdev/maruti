...
<html lang="en">
    <head>
        ...
        <title>Maruti Studio | Homepage Offer Images </title>
        <?php
            include('css.php')
        ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Offer Images</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active"> Offers Images</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Change Offers Images
                            </div>
                            <div class="card-body">
                                <form class="homeImg" action="" name="offerImg" id="offerImg" enctype="multipart/form-data">
                                    <div class="container-head">
                                        <div class="row inner-div">
                                            <h3>For top slider</h3>
                                            <div class="col-sm-2 mb-3">
                                                Offer Image 1  <span class="mandatory">*</span>
                                            </div>
                                            ...
                                            <div class="col-sm-2 mb-3">
                                                Offer Image 2  <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-4 mb-3">
                                        ...
                                        <div class="row inner-div">
                                            <h3>Update Text Of Offer Banner</h3>
                                            <div class="col-sm-2 mb-3">
                                            ...
                                            <div class="col-sm-2 mb-3">
                                                Text Heading 1  <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-4 mb-3">
                                                <input type="text" name="heading1" id="heading1" class="form-control">
                                            </div>
                                            <div class="col-sm-2 mb-3">
                                                Text Heading 2  <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-4 mb-3">
                                                <input type="text" name="heading2" id="heading2" class="form-control">
                                            </div>
                                            <div class="col-sm-2 mb-3">
                                                Text Description 1  <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-4 mb-3">
                                                <input type="text" name="textDesc1" id="textDesc1" class="form-control">
                                            </div>
                                            <div class="col-sm-2 mb-3">
                                                Text Description 2  <span class="mandatory">*</span>
                                            </div>
                                            <div class="col-sm-4 mb-3">
                                                <input type="text" name="textDesc2" id="textDesc2" class="form-control">
                                            </div>
                                            
                                            <input type="hidden" name="endurl" id="endurl" value="updateofferImage" />
                                        </div>
