<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark bgUiChange">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">COSMEDS</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="product.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-trailer"></i></div>
                                Products
                            </a>
                            ...
                            <a class="nav-link" href="homeImg.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-images"></i></div>
                                Homepage Images
                            </a>
                            <a class="nav-link" href="custEnquiry.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-images"></i></div>
                                Enquiries
                            </a>
                            <a class="nav-link" href="offerImg.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-images"></i></div>
                                Offer Images
                            </a>
                            ...
                            <a class="nav-link" href="subUsers.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-images"></i></div>
                                Subscribed Users
                            </a>
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        Cosmeds Admin
                        <br>
                        <button type="button" class="btn btn-primary mt-2 logout">Logout</button>
                    </div>
                </nav>
            </div>